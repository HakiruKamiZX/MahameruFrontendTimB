  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-item fill="solid">
        ...
        <ion-input placeholder="Nama" v-model="nama" class="custom"></ion-input>
      </ion-item>
      
      <ion-item fill="outline">
        <ion-label position="stacked">Phone</ion-label>
        <ion-input type="tel" placeholder="Phone Number" v-model="telp" class="custom"></ion-input>
    ...
    <ion-grid>
      <ion-row>
        <ion-col>
          <button @click="getValues()" class="buttonw" type="button">Save Changes</button>
        </ion-col>
        <ion-col></ion-col>
        <ion-col>
          <button class="delete" type="button">Delete friend</button>
        </ion-col>
      </ion-row>
    </ion-grid>
...
export default  defineComponent({
  ...
  methods:{
    getValues() {
      var pond = { 'name': this.nama, 'no_telp': this.telp}
      console.log(pond)  
    }
  }
});
